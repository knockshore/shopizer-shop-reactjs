  ...
  return (
    <Fragment>
      <MetaTags>
        ...
        { <meta
          name="description"
          content="Vente et installation de poêles et foyers au gaz et granules. BBQ et accessoires. Perfecto Gaz, votre partenaire de confiance pour tous vos besoins en chauffage au gaz propane"
      ...
      />
        ...
        <div className="container pt-20 pb-50" >
          ...
          <p className="content-size">
          Depuis 2000, nous nous engageons à fournir des solutions de chauffage fiables, efficaces et respectueuses de l'environnement pour les résidences et les entreprises. Que vous envisagiez de remplacer votre système de chauffage existant ou d'installer un nouveau système, notre équipe expérimentée est là pour vous guider à chaque étape du processus.
          </p>
          <p className="content-size">
          Nous offrons une gamme complète d'appareils de chauffage au gaz, soigneusement sélectionnés parmi les meilleures marques de l'industrie, pour répondre à vos besoins spécifiques en matière de confort et d'efficacité énergétique.
          </p>
          <p className="content-size">
          ...
          &nbsp;<a href="/contact">Contactez-nous</a> dès aujourd'hui pour en savoir plus sur nos produits et services de chauffage au gaz. Faites le choix de la qualité, de la fiabilité et du confort avec Perfecto Gaz.
